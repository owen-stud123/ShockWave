      ...
      <div className="max-w-7xl mx-auto py-8 sm:py-10 md:py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-indigo-400">ShockWave</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-300">
              <li>
                <Link to="/browse" className="hover:text-white transition-colors inline-block">
                  Find Work
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="hover:text-white transition-colors inline-block">
                  Build Portfolio
                </Link>
              </li>
              <li>
